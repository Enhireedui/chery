...
export default function MongoliaScene() {
  return (
    <picture data-depth="0.4" className="ms-bg__pic">
      <source media="(max-width: 767px)" type="image/avif" srcSet="/assets/img/ms-gold-tall.avif" />
      <source media="(max-width: 767px)" type="image/webp" srcSet="/assets/img/ms-gold-tall.webp" />
